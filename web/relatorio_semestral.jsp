        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <b><h2>Relatório de venda semestral do ano de <%=request.getParameter("ano")%></h2></b>
                    <table class="table" class="table" style="width: 90%;">
                        <thead>
                            <tr>
                                <th><h3>Nome</h3></th>
                                <th><h3>Valor</h3></th>
                        ...
                        <tbody>
                            ...
                            <%
                                ...
                                double venda = 0;
                                double despesa = 0;
                                ResultSet vendaano = b.selectVendadoSemestre(request.getParameter("ano"),request.getParameter("sem"));
                                while(vendaano.next()){
                            %>
                                    <tr>
