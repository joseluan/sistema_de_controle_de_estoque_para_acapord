        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <b><h2>Relatório de venda no mês de <%=request.getParameter("ano")%></h2></b>
                    ...
                    <table class="table" class="table" style="width: 90%;">
                        ...
                        <tbody>
                            ...
                            <%
                                ...
                                double venda = 0;
                                double despesa = 0;
                                ResultSet vendaano = b.selectVendadoMes(request.getParameter("ano"),request.getParameter("mes"));
                                while(vendaano.next()){
                            %>
                                    <tr>
